...
function Header() {
  ...
  return (
    <header className="dark:bg-darkBlue dark:text-white  bg-white flex justify-between h-14 items-center px-6 text-veryDarkBlue shadow-md fixed right-0 left-0 z-10 ">
